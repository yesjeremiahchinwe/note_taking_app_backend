...
const createNewUser = async (req, res) => {
    ...
    sendEmail(email, "Congratulations! Your account has been created successfully!", "We're glad to have you join us on Notes - your number one note taking app. Thank you for signing up.")
